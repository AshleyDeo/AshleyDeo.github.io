let patternNum; //press # on keyboard to switch patterns
let colorSwitch;
let color1;
let bcolor1;
let timer1;
...
function keyPressed() {
    if (keyCode == 48) {
        console.log("Press number 1 - 5 for patterns");
        if (patternNum == 1) {
            console.log("Press C to turn on/off let changer");
        }
        if (patternNum == 2) {
